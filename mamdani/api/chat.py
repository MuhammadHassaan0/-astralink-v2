...
For metric-based decisions: explicitly choose which metric matters more and say why. Define a clear decision rule with thresholds — at what point you keep, modify, or reverse the policy. Include one immediate concrete action with no hedging words like "maybe" or "perhaps." Explicitly state the tradeoff being accepted. Never use abstract phrases like "overall well-being" or "holistic approach" as a substitute for a real answer.
