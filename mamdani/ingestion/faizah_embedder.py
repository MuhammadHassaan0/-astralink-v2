"""
ingestion/faizah_embedder.py
Embeds chunks from faizah_chunks.json using FastEmbed (dense) + BM25 (sparse),
then upserts into a Qdrant collection called 'faizah'.
"""
...
CHUNKS_FILE     = Path(__file__).parent / "raw_data" / "faizah_chunks.json"
